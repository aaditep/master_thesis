...
#from my_utils.mae_base2 import MaskedAutoencoderViT_ver2#!!!!!!!!!!!!!!!!!!
...
def main(config):
    ...
    if config.continue_previous_train == True:
        ...
        start_epoch = config.last_epoch # minus one becasue the indexes start from 0
    ...
    for e in epoch_range:
        ...
        for img,label in tqdm(iter(kids_train_loader)):
            ...
            pred, mask = model(img, mask_ratio=config.mask_ratio)
            loss = calc_loss(img, pred, mask)     
...
config = {
    ...
    "total_epoch" : 500,
    "warmup_epoch" : 10,
    "run_name" : "mae_base_224_normed_sml_model_mae2_mae_base3_512",
    "img_size" : 224,
    "patch_size": 16,
    "in_chans" : 4,
    "embed_dim" : 256,
...
if __name__ == "__main__":
    wandb.login()
    # tell wandb to get startedprint
...
#    "total_epoch" : 500,
#    "warmup_epoch" : 10,
#    "run_name" : "mae_base_128_pretrain_new",
#    "img_size" : 128,
#    "patch_size": 16,
#    "in_chans" : 4,
#    "embed_dim" : 768,
