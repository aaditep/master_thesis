...
class MaskedAutoencoderViT_ver2(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=4,
        ...
        self.encoder = Encoder(img_size,patch_size,in_chans,num_patches, embed_dim, num_heads, mlp_ratio, norm_layer, depth, **kwargs)
    ...
    def initialize_weights(self):
        ...
        decoder_pos_embed = get_2d_sincos_pos_embed(self.decoder.decoder_pos_embed.shape[-1], int(self.encoder.patch_embed.num_patches**.5), cls_token=True)
...
class Encoder(nn.Module):
    def __init__(self,img_size,patch_size,in_chans,num_patches, embed_dim,num_heads, mlp_ratio, norm_layer, depth, **kwargs):
        super().__init__()
        #define for encoder: 
