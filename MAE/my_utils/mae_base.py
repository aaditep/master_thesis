...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=4,
        ...
        self.decoder_embed = nn.Linear(embed_dim, decoder_embed_dim, bias=True)#True before
        ...
        self.decoder_pred = nn.Linear(decoder_embed_dim, patch_size**2 * in_chans, bias=True) # decoder to patch #true before
        # --------------------------------------------------------------------------

        self.norm_pix_loss = norm_pix_loss
        if self.norm_pix_loss == True:
            print("using norm pix loss")
        else:
            print("not using norm pix loss")
