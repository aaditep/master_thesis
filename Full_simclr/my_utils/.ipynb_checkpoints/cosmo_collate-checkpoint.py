...
import h5py
from my_utils.cosmo_loader import  kids450_files_localscratch

def cosmotrain_collate_fn(idxs):
        """
        ...
        x_batch = torch.empty((batch_size,1 ,4,resolution,resolution)) #empty tensor for images
